    ...
    <div className="bg-slate-950 text-slate-300 text-xs py-2.5 px-4 border-b border-slate-800">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* WhatsApp — mantenemos verde para reconocimiento de marca */}
          <a
            href="https://wa.me/525512345678"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-[#25D366]/20 hover:bg-[#25D366]/30 text-[#4ade80] border border-[#25D366]/30 transition-all px-2.5 py-1 rounded-full font-semibold"
          >
            <WaIcon />
            WhatsApp
          </a>
